...
**Project**: now-and-here-replicator 

**URL**: https://run.gptengineer.app/projects/REPLACE_WITH_PROJECT_ID/improve

**Description**: Create a replicate of this website: hereandnowai.com 
...
```sh
git clone https://github.com/GPT-Engineer-App/now-and-here-replicator.git
cd now-and-here-replicator
npm i
